...
module.exports.run = async function ({
	...
	try {
		...
		if (!input) {
			...
			helpMessage += `\n\n  Page [💬] ${page}/${Math.ceil(commands.length / pages)} \n━━━━━━━━━━━\n ATH BOT: Cette bot est créé et développer par Athanasius. En cas de problème, n'oublie pas de contacter mon administrateur sur:https://www.facebook.com/AthanasiusRoger \n━━━━━━━━━━━\n Créateur: Athanasius Roger'.`;
